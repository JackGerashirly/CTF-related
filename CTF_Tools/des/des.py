...
class Des:
    ...
    def encrypt(self):
        ...
        # Generate Round Keys
        key = raw_input("Please input your key in Hex: ")
        self.generate_key(key)

        # Change to 64-bit Binary
        plaintext = raw_input("Please input your plaintext in Hex: ")
    ...
    def decrypt(self):
        ...
        # Change to 64-bit Binary
        cipher = raw_input("Please input your cipher in Hex: ")
